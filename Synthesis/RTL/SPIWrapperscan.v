module SPI_Wrapper #(
    ...
    wire Func_clk, Func_rst;
    assign Func_clk = test_mode ? scan_clk : clk;
    assign Func_rst = test_mode ? scan_rst : arst_n;
    ...
    SPI_Slave SPI_slave (
                ...
                .clk(Func_clk),           /*  clock signal input */
                .arst_n(Func_rst),     /*  active low synchronous reset */
    ...
    single_port_Ram #(
                ...
                .clk(Func_clk),              /*  clock signal input */
                .arst_n(Func_rst),        /*  active low asynchronous reset */
